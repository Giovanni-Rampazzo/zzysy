      ...
      <div style={{ padding:"12px 14px" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          ...
          <div style={{ display:"flex", gap:"4px" }}>
            <button onClick={onEdit} style={{ padding:"4px 10px", border:`1px solid ${colors.border}`, borderRadius:"6px", background:"#FFF", fontSize:"0.72rem", cursor:"pointer", color:colors.text, fontWeight:600 }}>Editar</button>
