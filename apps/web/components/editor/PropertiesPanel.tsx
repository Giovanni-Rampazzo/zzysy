            ...
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                <div>
                  ...
                  <select value={fontFamily} onChange={e=>apply("fontFamily",e.target.value)} style={{...inp,fontFamily:fontFamily}}>
                    {FONTS.map(f => (
